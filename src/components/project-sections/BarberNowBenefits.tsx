    ...
    <section className="section-padding">
      <div className="container-max">
        ...
        <div className="bg-turnbold-bg rounded-xl p-8">
          <h3 className="text-2xl font-bold text-center mb-8">{t('barbernow.benefits.workflow.title')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-turnbold-green mb-2">{t('barbernow.benefits.workflow.steps.0.title')}</div>
              <p className="text-turnbold-text">{t('barbernow.benefits.workflow.steps.0.description')}</p>
            </div>
            <div>
              <div className="text-3xl font-bold text-turnbold-green mb-2">{t('barbernow.benefits.workflow.steps.1.title')}</div>
              <p className="text-turnbold-text">{t('barbernow.benefits.workflow.steps.1.description')}</p>
            </div>
            <div>
              <div className="text-3xl font-bold text-turnbold-green mb-2">{t('barbernow.benefits.workflow.steps.2.title')}</div>
              <p className="text-turnbold-text">{t('barbernow.benefits.workflow.steps.2.description')}</p>
            </div>
          </div>
        </div>
      </div>
...
export default BarberNowBenefits;