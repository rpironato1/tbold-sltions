      ...
      <Tabs defaultValue="contacts">
        ...
        <TabsContent value="contacts">
          <Card>
            ...
            <CardContent>{renderTable(contacts, 'contact')}</CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="leads">
          <Card>
            ...
            <CardContent>{renderTable(leads, 'lead')}</CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="briefings">
          <Card>
            ...
            <CardContent>{renderTable(briefings, 'briefing')}</CardContent>
          </Card>
        </TabsContent>
      </Tabs>
